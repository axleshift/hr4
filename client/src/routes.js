...
const ImportantTrainingNotice = React.lazy(
    () => import('./views/ui/TrainingManagement/ImportantTrainingNotice'),
)
...
const routes = [
    ...
    {
        path: '/ui/TrainingManagement/TrainingDelivery',
        name: 'TrainingDelivery',
        element: TrainingDelivery,
    },
    {
        path: '/ui/TrainingManagement/ClassOftraining',
        name: 'ClassOfTraining',
        element: ClassOfTraining,
    },
    {
        path: '/ui/TrainingManagement/ImportantTrainingNotice',
        name: 'ImportantTrainingNotice',
        element: ImportantTrainingNotice,
    },
