...
Route::put('/employee-training-status/{employeeId}', [EmployeeStatusController::class, 'update']);
Route::get('/employee-training-status', [EmployeeStatusController::class, 'index']);
